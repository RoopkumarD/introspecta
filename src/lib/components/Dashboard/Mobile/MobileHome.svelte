<script lang="ts">
  ...
  import Entry from "$lib/components/Dashboard/Desktop/Entry.svelte";
  ...
  import EntryView from "$lib/components/Dashboard/Mobile/EntryView.svelte";
