...
declare interface IdConfiguration {
...
declare interface GoogleCredentialResponse extends CredentialResponse {
  client_id?: string;
}

declare interface GsiButtonConfiguration {
...
declare interface PromptMomentNotification {
...
declare interface OverridableTokenClientConfig {
  /**
...
declare interface CodeClientConfig {
  /**
...
declare type MomenListener = (
  promptMomentNotification: PromptMomentNotification,
) => void;

declare interface UseLoadGsiScriptOptions {
  /**
...
declare interface GoogleOAuthContextProps {
  clientId: string;
  scriptLoadedSuccessfully: boolean;
}

declare interface GoogleOAuthProviderProps extends UseLoadGsiScriptOptions {
  clientId: string;
}

declare interface NonOAuthError extends Error {
  /**
...
declare type SuccessTokenResponse = Omit<
  TokenResponse,
  "error" | "error_description" | "error_uri"
>;
declare type ErrorTokenResponse = Pick<
  TokenResponse,
  "error" | "error_description" | "error_uri"
>;
...
declare type SuccessAuthCodeResponse = Omit<
  CodeResponse,
  "error" | "error_description" | "error_uri"
>;
declare type ErrorAuthCodeResponse = Pick<
  CodeResponse,
  "error" | "error_description" | "error_uri"
>;
...
declare type UseGoogleLoginOptions =
...
declare interface UseGoogleOneTapLoginOptions {
